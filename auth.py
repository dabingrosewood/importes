        ...
        for fields in fields_data:
            ...
            action = {
                ...
                "_source": {
                    ...
                    "time": fields[0],
                    "sourceUser&domain": fields[1],
                    "destinationUser&domain": fields[2],
                    "source_computer": fields[3],
                    "destination_computer": fields[4],
                    "authenticationType": fields[5],
                    "logonType": fields[6],
                    "authOrientation": fields[7],
                    "result": fields[8],
                }
            }
...
if __name__ == '__main__':
    ...
    i=0
    datalist=[]
    with open("/data/SDDMCS/LA_orgs/auth.txt") as f:
        while i<batchsize:
            i+=1
